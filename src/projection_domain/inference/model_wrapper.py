...
#import models
from models.MR_LKV_projection import MR_LKV
...
#Model wrapper classes for projection domain. These are used to wrap the original models and make them compatible with the training and inference code. This is especially useful for models that require some special handling, such as SwinIR which requires resizing the input to a fixed size.
